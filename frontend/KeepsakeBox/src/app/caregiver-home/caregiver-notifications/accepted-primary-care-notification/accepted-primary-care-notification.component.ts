...
@Component({
  selector: 'app-accepted-primary-care-notification',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './accepted-primary-care-notification.component.html',
  styleUrl: './accepted-primary-care-notification.component.css',
})
export class AcceptedPrimaryCareNotificationComponent implements OnInit {
