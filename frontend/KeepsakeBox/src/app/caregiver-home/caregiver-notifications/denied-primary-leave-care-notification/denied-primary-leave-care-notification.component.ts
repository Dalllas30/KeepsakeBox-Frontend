...
@Component({
  selector: 'app-denied-primary-leave-care-notification',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './denied-primary-leave-care-notification.component.html',
  styleUrl: './denied-primary-leave-care-notification.component.css',
})
export class DeniedPrimaryLeaveCareNotificationComponent implements OnInit {
