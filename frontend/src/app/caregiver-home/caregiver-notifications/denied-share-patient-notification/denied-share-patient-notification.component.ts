...
@Component({
  selector: 'app-denied-share-patient-notification',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './denied-share-patient-notification.component.html',
  styleUrl: './denied-share-patient-notification.component.css',
})
export class DeniedSharePatientNotificationComponent implements OnInit {
