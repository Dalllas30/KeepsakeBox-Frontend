...
@Component({
  selector: 'app-removed-from-patient-notification',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './removed-from-patient-notification.component.html',
  styleUrl: './removed-from-patient-notification.component.css',
})
export class RemovedFromPatientNotificationComponent implements OnInit {
