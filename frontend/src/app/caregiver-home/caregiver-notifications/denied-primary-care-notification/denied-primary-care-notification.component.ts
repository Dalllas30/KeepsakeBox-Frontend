...
@Component({
  selector: 'app-denied-primary-care-notification',
  standalone: true,
  imports: [CommonModule, TranslateModule],
  templateUrl: './denied-primary-care-notification.component.html',
  styleUrl: './denied-primary-care-notification.component.css',
})
export class DeniedPrimaryCareNotificationComponent implements OnInit {
